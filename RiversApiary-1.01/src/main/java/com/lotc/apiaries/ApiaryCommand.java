/**
 * RiversApiary v1.0 — ApiaryCommand.java
 * Command executor & tab completion for /apiary give and related utilities.
 *
...
public class ApiaryCommand implements CommandExecutor, TabCompleter {
    ...
    /**
     * asList: Helper/function within RiversApiary.
     */
    ...
    /**
     * ApiaryCommand: Helper/function within RiversApiary.
     */
    public ApiaryCommand(ApiaryPlugin plugin){ }

    @Override
    /**
     * onCommand: Helper/function within RiversApiary.
     */
    ...
    @Override
    /**
     * onTabComplete: Helper/function within RiversApiary.
     */
